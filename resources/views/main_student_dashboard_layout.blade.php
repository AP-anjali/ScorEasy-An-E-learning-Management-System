...
<head>
    ...
    @yield("title")
    @yield("style")
    <link rel="shortcut icon" href="{{ asset('student/assets/img/icon.png') }}">
...
<body>
    ...
    @include('main_student_dashboard_header_layout')
    @include('main_student_dashboard_sidebar_layout')
