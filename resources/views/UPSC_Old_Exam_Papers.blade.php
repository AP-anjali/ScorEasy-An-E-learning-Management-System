...
<head>
   ...
   <title>SCOREASY | UPSC Exam Papers</title>
...
<!-- ================================================ UPSC Exam old question paper ================================================ -->

<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: -30px;">"UPSC" Exam Old Question Papers... !</h1>
</section>
...
<div class="web_video_list_container" style = "margin-top: 50px; ">
    ...
    <section class="teachers">
        <div class="search-tutor" style = "margin-top: 20px; border: 1px solid rgba(0,0,0,.2); box-shadow: 5px 5px 5px rgba(0,0,0,.2);">
            <input type="text" id="searchBox" name="search_box" placeholder="Search UPSC Old Exam Paper..." required maxlength="200" oninput="filterExamPapers()">
    ...
    <div class="web_video_tutorials_container" style="margin-top: 40px; display : block;">
        @if(count($All_UPSC_EXAM_OLD_QUESTION_PAPERS) > 0)
            @foreach($All_UPSC_EXAM_OLD_QUESTION_PAPERS as $EACH_UPSC_EXAM_OLD_QUESTION_PAPER)  
                <div class="web_each_video" style="display: flex; flex-direction: row; margin-top: 30px;">
                    <div class="effect_content_container">
                        <div class="video_image_mamma">
                            <a href="#"><img src="{{ asset('storage/' . $EACH_UPSC_EXAM_OLD_QUESTION_PAPER->material_Thumbnail_Image) }}" style="height: 200px; width: 320px; " class="video_thumbnail_image" alt="video_tutorial_Thumbnail_Image"></a>
                        </div>
                        <a href="{{ route('Old_exam_question_paper_PDF', $EACH_UPSC_EXAM_OLD_QUESTION_PAPER->id) }}" target="_blank">
                            <div class = "effect_content">
                                <img src="{{ asset('img/pdf_icon_for_layer_resized.png') }}" alt="pdf icon">
                                <p id="effect_text">UPSC Exam Old Question Paper</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="other_container" style = "padding-left: 20px; padding-top: 30px; width: 100%;">
                        <div class="web_each_video_info flex_style">
                            <!-- <a href=""><img src="{{ asset($EACH_UPSC_EXAM_OLD_QUESTION_PAPER->admin->profile_pic) }}" alt="faculty chanel profile pic" style="height: 40px; border-radius: 50%;" class="faculty_profile_pic"></a> -->
                            <div class="video_other_info">
                                <a href="{{ route('Old_exam_question_paper_PDF', $EACH_UPSC_EXAM_OLD_QUESTION_PAPER->id) }}" target="_blank" id = "material_title">{{$EACH_UPSC_EXAM_OLD_QUESTION_PAPER->material_title}}</a>
                                <br><br>
                                <p id = "material_des">{{$EACH_UPSC_EXAM_OLD_QUESTION_PAPER->material_description}}</p><br>
                                <!-- <a href="#"><p id="faculty_name">{{$EACH_UPSC_EXAM_OLD_QUESTION_PAPER->admin->admin_name}}</p></a> -->
