...
<head>
   ...
   <title>{{ $video_tutorial_to_display->video_tutorial_title }}</title>
   ...
   <div class="row">
        <div class="play-video">
            ...
            @if(isset($student_session))
                @if($student_session->is_subscribed == 1)
                    <video controls autoplay>
                        <source src="{{ asset('storage/' . $video_tutorial_to_display->video_tutorial_url) }}" type = "video/mp4">
                    </video>
                @else
            ...
            <div class="video-tags">
                ...
                @foreach(explode(' ', $video_tutorial_to_display->video_tutorial_keywords_or_tags) as $tag)  
                    <a href="#">#{{ $tag }}</a>
                @endforeach
                <!-- <a href="#">#UPSC</a> <a href="#">#UPSC1</a> <a href="#">#UPSC2</a> <a href="#">#UPSC3</a> -->
            </div>
            <br>
            <h3>{{ $video_tutorial_to_display->video_tutorial_title }}</h3>
            ...
            <div class="publisher">
                <a href=""><img src="{{ asset('storage/' . $video_tutorial_to_display->faculty->profile_pic) }}" alt="faculty chanel profile pic" style="height: 40px; border-radius: 50%; margin-right: 12px;" class="faculty_profile_pic"></a>
                <div>
                    <p>{{ $video_tutorial_to_display->faculty->name }}</p>
        ...
        <div class="video-right-sidebar">
            ...
            @foreach($other_videos as $other_video)
                <div class="side-video-list">
                    <a href="{{ route('video', $other_video->id) }}" class="small-video-thumbnail"><img src="{{ asset('storage/' . $other_video->video_tutorial_Thumbnail_Image) }}" alt="sidebar video thumbnail" ></a>
                    <div class="video_other_info">
                        <a href="{{ route('video', $other_video->id) }}">{{ $other_video->video_tutorial_title }}</a>
                        <div class="bas_have">
                            <a href=""><img src="{{ asset('storage/' . $other_video->faculty->profile_pic) }}" alt="faculty chanel profile pic" style="width: 35px; border-radius: 50%;" class="faculty_profile_pic"></a>
                            <div class="bas_bas_bas">
                                <p>{{ $other_video->faculty->name }}</p>
