...
<style>
    ...
    *{
    ...
    .text-fields.PDF_tutorial_status::after{
        content: 'PDF Tutorial Status';
        background-color: #fff;
        position: relative;
        padding: 0 4%;
        left: -210px;
...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From updating_pdf_tutorial_from_admin_page</div><br> -->
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <a href="{{ route('view_of_admin_for_pdf_type_tutorial') }}" class="loginbtn">Back</a>
                </div>
                <form action="{{ route('updating_pdf_tutorial_from_admin_page_form_submission', $pdf_tutorial_to_update_from_admin->id) }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="signup-form-content">
                        <div class="stage1-content">
                            ...
                            <div class="button-container" style="margin-top : -10px;">
                                <div class="text-fields PDF_tutorial_title">
                                    ...
                                    <input type="text" name="PDF_tutorial_title" id="PDF_tutorial_title" value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_title }}" required>
                                </div>
                                <div class="text-fields PDF_tutorial_description">
                                    ...
                                    <input type="text" name="PDF_tutorial_description" id="PDF_tutorial_description" value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_description }}" required>
                                </div>
                            </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_selected_Language">
                                    ...
                                    <select name="PDF_tutorial_selected_Language" id="my_list2" required>
                                        <option value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_Language }}" selected>{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_Language }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields PDF_tutorial_keywords_or_tags">
                                    ...
                                    <input type="text" name="PDF_tutorial_keywords_or_tags" min="0" id="PDF_tutorial_keywords_or_tags" value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_keywords_or_tags }}" required>
                                </div>
                            </div>
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_selected_course_name">
                                    ...
                                    <select name="PDF_tutorial_selected_course_name" id="my_list5" required>
                                        <option value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_course_name }}" selected>{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_course_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields PDF_tutorial_selected_subject_name">
                                    ...
                                    <select name="PDF_tutorial_selected_subject_name" id="my_list6" required>
                                        <option value = "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_subject_name }}" selected>{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_subject_name }}&nbsp;&nbsp;&nbsp;&nbsp;</option>
                        ...
                        <div class="stage3-content">
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_status khaskao" style = "width: 290px;">
                                    <label for="PDF_tutorial_status"><i class='bx bx-objects-vertical-bottom' style='color:#6487cb'></i></i></label>
                                    <select name="PDF_tutorial_status" id="my_list10" required>
...
<script>
    ...
    function validateStage1() {
        ...
        if ((!PDF_tutorial_path.trim() || !PDF_tutorial_path === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_path }}") &&
            (!PDF_tutorial_title.trim() || !PDF_tutorial_title === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_title }}") &&
            (!PDF_tutorial_description.trim() || !PDF_tutorial_description === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_description }}")) {
    ...
    function validateStage2() {
        ...
        if ((!PDF_tutorial_selected_Language.trim() || !PDF_tutorial_selected_Language === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_Language }}") &&
            (!PDF_tutorial_keywords_or_tags.trim() || !PDF_tutorial_keywords_or_tags === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_keywords_or_tags }}") &&
            (!PDF_tutorial_selected_course_name.trim() || !PDF_tutorial_selected_course_name === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_course_name }}") &&
            (!PDF_tutorial_selected_subject_name.trim() || !PDF_tutorial_selected_subject_name === "{{ $pdf_tutorial_to_update_from_admin->PDF_tutorial_selected_subject_name }}")) {
    ...
    document.getElementById('Current_PDF').addEventListener('click', function() {
        var id_for_updatepage_url = {{ $pdf_tutorial_to_update_from_admin->id }}; 
        var pdf_tutorial_id = {{ $pdf_tutorial_to_update_from_admin->id }}; 
        window.location.href = '/main_admin_dashboard_update_tutorial_page/updating_pdf_tutorial_from_admin_page/' + id_for_updatepage_url + '/show_current_pdf_to_admin_for_update_pdf_tutorial_page/' + pdf_tutorial_id;
    });

    document.getElementById('Current_Thumbnail_Image').addEventListener('click', function() {
        var id_for_updatepage_url = {{ $pdf_tutorial_to_update_from_admin->id }}; 
        var pdf_tutorial_id = {{ $pdf_tutorial_to_update_from_admin->id }}; 
        window.location.href = '/main_admin_dashboard_update_tutorial_page/updating_pdf_tutorial_from_admin_page/' + id_for_updatepage_url + '/show_current_thumbnail_image_to_admin_for_update_pdf_tutorial_page/' + pdf_tutorial_id;
    });
