...
<head>
   ...
   <title>SCOREASY | Contact us | Subscription</title>
...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="https://formsubmit.co/anjalipatel3074@gmail.com" method="POST">
         ...
         <input type="button" value="Exit" class="inline-btn" style = "margin-right: 10px; width: 30%;" onclick="goBack()">
...
<script>
    function goBack()
    {
        window.location.href = "{{ route('contact_us_page_for_subscription') }}";
        window.close();
    }
</script>
