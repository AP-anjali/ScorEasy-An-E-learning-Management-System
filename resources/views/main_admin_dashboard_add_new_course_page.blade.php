...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_add_new_course_page</div><br> -->
            ...
            <div class="center">
                <h2 id="main-heading">Add New Course</h2>

                <div class="form_container">
                    <form action="{{ route('adding_new_course') }}" method="POST" id="form">
                        @csrf
                        <input type="text" name="course_name" placeholder = "Enter Course name ..." id="text" required><br><br>
