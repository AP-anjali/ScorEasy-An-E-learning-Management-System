...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_update_subject_page</div><br> -->
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="side-big-headning" style="text-align: center;">Subjects Updation</p>
                    <p class="primary-bg-text">Update Subjects With<br>All The Required Informations</p>
                    <a onclick="return confirm('Are you sure to Exit From Subject Editing !')" href="{{ route('main_admin_dashboard_show_subjects_page') }}" class="loginbtn">Exit</a>
                </div>
                <form action="{{ route('updating_new_subject', $subject_to_update->id) }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Update Subject</p>
                            ...
                            <div class="button-container" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center;">
                                <div class="text-fields selected_course_name" style="width: 300px;">
                                    ...
                                    <select name="selected_course_name" id="my_list2" required style="padding-left: 20px;">
                                        <option value="{{ $subject_to_update->selected_course_name }}" selected>{{ $subject_to_update->selected_course_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                        ...
                        <div class="stage2-content">
                            <div class="button-container" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center;">
                                <div class="text-fields subject_name" style="width: 300px;">
                                    ...
                                    <input type="text" name="subject_name" id="subject_name" value="{{ $subject_to_update->subject_name }}"  required>
                        ...
                        <div class="stage3-content">
                            <div class="button-container" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center;">
                                <div class="custome-text-fields subject_description">
                                    <textarea name="subject_description" id="subject_description" style="width: 300px !important; height: 120px !important;" required>{{ $subject_to_update->subject_description }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="stage4-content">
                            <div class="tc-container">
                                <label for="tc" class="tc">
                                    ...
                                    By submitting subject details, you agree to the <a href="#">terms and conditions</a>
                                </label>
                            </div>
                            <div class="pagination-btns">
