...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_add_new_hero_image_page</div><br> -->
            ...
            <div class="center">
                <h2 id="main-heading">Add New Hero Image</h2>

                <div class="form_container">
                    <form action="{{ route('adding_new_hero_image') }}" method="POST" id="form" enctype="multipart/form-data">
                        @csrf
                        <input type="file" name="hero_image" id="text" required><br><br>
