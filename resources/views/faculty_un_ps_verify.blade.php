...
<body>
    <div class="cover">
        ...
        <div class="form-box login">
            <h2 class="animation" style="--i:0; --j:21;">Faculty Login</h2>
            <form action="{{ route('faculty_un_ps_verification_method') }}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <script src="{{ asset('js/faculty_verify_un_ps.js') }}"></script>
