...
@include('website_menu')
    ...
    <section class="teachers">
        <h1 class="heading" style = "margin-top: 45px; margin-bottom: -30px;">Hello, "{{$student_session->name}}"</h1>
    </section>
    ...
    <div id="feedback_form_body">
        ...
        <div class="wrapperanjali">
            ...
            <form action="{{ route('student_feedback_form_submission', $student_session->id) }}" method = "post">
                @csrf
                <div class="rating">
