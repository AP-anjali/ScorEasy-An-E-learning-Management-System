...
<style>
    ...
    *{
    ...
    .text-fields.video_tutorial_status::after{
        content: 'Video Tutorial Status';
        background-color: #fff;
        position: relative;
        padding: 0 4%;
        left: -210px;
...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From updating_video_tutorial_from_admin_page</div><br> -->
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <a href="{{ route('view_of_admin_for_video_type_tutorial') }}" class="loginbtn">Back</a>
                </div>
                <form action="{{ route('updating_video_tutorial_from_admin_page_form_submission', $video_tutorial_to_update_from_admin->id) }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="signup-form-content">
                        <div class="stage1-content">
                            ...
                            <div class="button-container" style="margin-top : -10px;">
                                <div class="text-fields video_tutorial_title">
                                    ...
                                    <input type="text" name="video_tutorial_title" id="video_tutorial_title" value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_title }}" required>
                                </div>
                                <div class="text-fields video_tutorial_description">
                                    ...
                                    <input type="text" name="video_tutorial_description" id="video_tutorial_description" value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_description }}" required>
                                </div>
                            </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields video_tutorial_selected_Language">
                                    ...
                                    <select name="video_tutorial_selected_Language" id="my_list2" required>
                                        <option value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_Language }}" selected>{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_Language }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields video_tutorial_keywords_or_tags">
                                    ...
                                    <input type="text" name="video_tutorial_keywords_or_tags" min="0" id="video_tutorial_keywords_or_tags" value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_keywords_or_tags }}" required>
                                </div>
                            </div>
                            <div class="button-container">
                                <div class="text-fields video_tutorial_selected_course_name">
                                    ...
                                    <select name="video_tutorial_selected_course_name" id="my_list5" required>
                                        <option value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_course_name }}" selected>{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_course_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields video_tutorial_selected_subject_name">
                                    ...
                                    <select name="video_tutorial_selected_subject_name" id="my_list6" required>
                                        <option value = "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_subject_name }}" selected>{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_subject_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                        ...
                        <div class="stage3-content">
                            <div class="button-container">
                                <div class="text-fields video_tutorial_status khaskao" style = "width: 290px;">
                                    <label for="video_tutorial_status"><i class='bx bx-objects-vertical-bottom' style='color:#6487cb'></i></i></label>
                                    <select name="video_tutorial_status" id="my_list10" required>
...
<script>
    ...
    function validateStage1() {
        ...
        if ((!video_tutorial_url.trim() || !video_tutorial_url === "{{ $video_tutorial_to_update_from_admin->video_tutorial_url }}") &&
            (!video_tutorial_title.trim() || !video_tutorial_title === "{{ $video_tutorial_to_update_from_admin->video_tutorial_title }}") &&
            (!video_tutorial_description.trim() || !video_tutorial_description === "{{ $video_tutorial_to_update_from_admin->video_tutorial_description }}")) {
    ...
    function validateStage2() {
        ...
        if ((!video_tutorial_selected_Language.trim() || !video_tutorial_selected_Language === "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_Language }}") &&
            (!video_tutorial_keywords_or_tags.trim() || !video_tutorial_keywords_or_tags === "{{ $video_tutorial_to_update_from_admin->video_tutorial_keywords_or_tags }}") &&
            (!video_tutorial_selected_course_name.trim() || !video_tutorial_selected_course_name === "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_course_name }}") &&
            (!video_tutorial_selected_subject_name.trim() || !video_tutorial_selected_subject_name === "{{ $video_tutorial_to_update_from_admin->video_tutorial_selected_subject_name }}")) {
    ...
    document.getElementById('Current_Video').addEventListener('click', function() {
        var id_for_updatepage_url = {{ $video_tutorial_to_update_from_admin->id }}; 
        var video_tutorial_id = {{ $video_tutorial_to_update_from_admin->id }}; 
        window.location.href = '/main_admin_dashboard_update_tutorial_page/updating_video_tutorial_from_admin_page/' + id_for_updatepage_url + '/show_current_video_to_admin_for_update_video_tutorial_page/' + video_tutorial_id;
    });

    document.getElementById('Current_Thumbnail_Images').addEventListener('click', function() {
        var id_for_updatepage_url = {{ $video_tutorial_to_update_from_admin->id }}; 
        var video_tutorial_id = {{ $video_tutorial_to_update_from_admin->id }}; 
        window.location.href = '/main_admin_dashboard_update_tutorial_page/updating_video_tutorial_from_admin_page/' + id_for_updatepage_url + '/show_current_thumbnail_image_to_admin_for_update_video_tutorial_page/' + video_tutorial_id;
    });
