...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_faculty_dashboard_show_all_tutorials_page</div><br> -->
            ...
            <div class="center">
                <h2 id="main-heading">Select Tutorial Type To Get Your Tutorials</h2>

                <div class="form_container">
                    <form action="{{ route('video_pdf_show_tutorials_switching_route') }}" method="POST" id="form">
                        @csrf
                        <div id="ddl">
