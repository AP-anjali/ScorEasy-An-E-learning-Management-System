...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            @if(Session()->has('add_video_tuts_route_msg'))

                <div class="msg" id="msg1">
                    {{session()->get('add_video_tuts_route_msg')}}
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="primary-bg-text">Upload Your Video Tutorials<br>With All The Required Informations</p>
                    <a href="{{ route('main_faculty_dashboard_add_new_tutorial_page') }}" class="loginbtn">Back</a>
                </div>
                <form action="{{ route('form_for_video_type_tutorial_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Add New Video Tutorial</p>
                        ...
                        <div class="stage1-content">
                            <div class="button-container">
                                <div class="file_uploader">
                                    ...
                                    <input type="file" name="video_tutorial_url" id="video_tutorial_url" required>
                                </div>
                                ...
                                <div class="file_uploader2">
                                    ...
                                    <input type="file" name="video_tutorial_Thumbnail_Image" id="video_tutorial_Thumbnail_Image" required>
                                </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields video_tutorial_title">
                                    ...
                                    <input type="text" name="video_tutorial_title" id="video_tutorial_title" placeholder="Video Tutorial Title" required>
                                </div>
                                <div class="text-fields video_tutorial_description">
                                    ...
                                    <input type="text" name="video_tutorial_description" id="video_tutorial_description" placeholder="Your Video description" required>
                                </div>
                            </div>
                        ...
                        <div class="stage2-content">
                            <div class="button-container">
                                ...
                                <div class="text-fields video_tutorial_keywords_or_tags">
                                    ...
                                    <input type="text" name="video_tutorial_keywords_or_tags" min="0" id="video_tutorial_keywords_or_tags" placeholder="Keywords For SEO" required>
                                </div>
                            </div>
                            <div class="button-container">
