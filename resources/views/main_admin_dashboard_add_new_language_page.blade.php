...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_add_new_language_page</div><br> -->
            ...
            <div class="center">
                <h2 id="main-heading">Add New Language</h2>

                <div class="form_container">
                    <form action="{{ route('adding_new_language') }}" method="POST" id="form">
                        @csrf
                        <input type="text" name="language_name" placeholder = "Enter Language ..." id="text"><br><br>
