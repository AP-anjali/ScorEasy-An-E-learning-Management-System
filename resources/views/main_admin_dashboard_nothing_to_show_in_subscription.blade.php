...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_nothing_to_show_in_courses</div><br> -->
            <div class="displaying_container">
                ...
                <input type="button" onclick="window.location.href = '/main_admin_dashboard/main_admin_dashboard_add_new_subscription_page'" value="Click Here To Add New Record" id="btn">
            </div>
        </div>
    </div>
@endsection