...
<head>
    ...
    <title>SCOREASY | Faculty Login</title>
...
<body>
    <div class="container">
        ...
        @if(session('showFacultyLoginAlert'))
                <script>
                    alert('To access further pages, please login first');
                    {!! session()->forget('showFacultyLoginAlert') !!}
                </script>
        @endif
        ...
        <div class="signup-form-container">
            ...
            <form action="{{ route('faculty_login_form_phone_no_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
                <?php
                    $mno=old('phone_no');
            ...
            <form action="{{ route('faculty_login_otp_verification_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
...
<script src="{{ asset('js/faculty_login_page.js') }}"></script>
<script>
