...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_add_new_old_question_paper_page</div><br> -->

            @if(Session()->has('add_old_question_paper_route_msg'))

                <div class="msg" id="msg1">
                    {{session()->get('add_old_question_paper_route_msg')}}
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="side-big-headning" style="text-align: center;">Old Question Papers</p>
                    <p class="primary-bg-text">Add Old Question Papers material<br>Of Existing Courses<br>With All The Required Informations</p>
                    <a href="{{ route('main_admin_dashboard') }}" class="loginbtn">Exit</a>
                </div>
                <form action="{{ route('adding_new_old_question_paper') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Add New Question Paper Material</p>
                    <div class="progressanjali-bar">
                        ...
                        <div class="stage">
                            <p class="tool-tip" style="white-space: nowrap;">Upload Material</p>
                    ...
                    <div class="signup-form-content">
                            ...
                            <div class="button-container" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center;">
                                <div class="text-fields selected_course_name" style="width: 300px;">
                                    ...
                                    <select name="selected_course_name" id="my_list2" required style="padding-left: 20px;">
                                        <option value="" selected disabled>Select Material Course&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                        ...
                        <div class="stage2-content">
                            <div class="file_uploader" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center; margin-left: 25%;">
                            ...
                            <div class="file_uploader_thumb" style="margin-top: 20px; text-align: center; align-items: center; justify-content: center; margin-left: 25%; width: 300px;">
                                <label for="Thumbnail_Image"><i  class='bx bxs-folder-open' style='color:#6487cb'></i></label>
                                <input type="file" name="material_Thumbnail_Image" id="Thumbnail_Image" required>
                            </div>
                        ...
                        <div class="stage3-content">
                            ...
                            <div class="button-container" style="margin-top: 20px; text-align: center; align-items: center; justify-content: center;">
                                <div class="custome-text-fields material_description">
                                    <textarea name="material_description" id="material_description" placeholder="Enter Material Description" style="width: 300px !important; height: 120px !important;" required></textarea>
                                </div>
                            </div>
...
<script>
    ...
    function validateStage2() {
        ...
        var Thumbnail_Image = document.getElementById("Thumbnail_Image").value;
       
        if (material === "" || Thumbnail_Image === "") {
