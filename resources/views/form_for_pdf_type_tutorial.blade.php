...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From form_for_pdf_type_tutorial</div><br> -->

            @if(Session()->has('add_pdf_tuts_route_msg'))

                <div class="msg" id="msg1">
                    {{session()->get('add_pdf_tuts_route_msg')}}
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="side-big-headning" style="text-align: center;">Tutorials Listing</p>
                    <p class="primary-bg-text">Upload Your PDF Tutorials<br>With All The Required Informations</p>
                    <a href="{{ route('main_faculty_dashboard_add_new_tutorial_page') }}" class="loginbtn">Back</a>
                </div>
                <form action="{{ route('form_for_pdf_type_tutorial_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Add New PDF Tutorial</p>
                        ...
                        <div class="stage1-content">
                            <div class="button-container">
                                <div class="file_uploader">
                                    ...
                                    <input type="file" name="PDF_tutorial_path" id="PDF_tutorial_path" required>
                                </div>
                                ...
                                <div class="file_uploader2">
                                    ...
                                    <input type="file" name="PDF_tutorial_Thumbnail_Image" id="PDF_tutorial_Thumbnail_Image" required>
                                </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_title">
                                    ...
                                    <input type="text" name="PDF_tutorial_title" id="PDF_tutorial_title" placeholder="PDF Tutorial Title" required>
                                </div>
                                <div class="text-fields PDF_tutorial_description">
                                    ...
                                    <input type="text" name="PDF_tutorial_description" id="PDF_tutorial_description" placeholder="Your PDF description" required>
                                </div>
                            </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_selected_Language">
                                    ...
                                    <select name="PDF_tutorial_selected_Language" id="my_list2" required>
                                        <option value="" selected disabled>Select Tutorial Language&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields PDF_tutorial_keywords_or_tags">
                                    ...
                                    <input type="text" name="PDF_tutorial_keywords_or_tags" min="0" id="PDF_tutorial_keywords_or_tags" placeholder="Keywords For SEO" required>
                                </div>
                            </div>
                            <div class="button-container">
                                <div class="text-fields PDF_tutorial_selected_course_name">
                                    ...
                                    <select name="PDF_tutorial_selected_course_name" id="my_list5" required>
                                        <option value="" selected disabled>Select Tutorial Course&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                ...
                                <div class="text-fields PDF_tutorial_selected_subject_name">
                                    ...
                                    <select name="PDF_tutorial_selected_subject_name" id="my_list6" required>
                                        <option value="" selected disabled>Select Tutorial Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
...
<script>
    ...
    function validateStage1() {
        ...
        var PDF_tutorial_Thumbnail_Image = document.getElementById("PDF_tutorial_Thumbnail_Image").files;
        ...
        if (PDF_tutorial_path === "" || PDF_tutorial_Thumbnail_Image.length === 0 || PDF_tutorial_title === "" || PDF_tutorial_description === "") {
    ...
    function validateStage2() {
        ...
        if (PDF_tutorial_selected_Language === "" || PDF_tutorial_keywords_or_tags === "" || PDF_tutorial_selected_course_name === "" || PDF_tutorial_selected_subject_name === "") {
