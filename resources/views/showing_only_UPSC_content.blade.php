...
<head>
   ...
   <title>SCOREASY | UPSC Content</title>
...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px; padding-left: 40%;">"UPSC" Area !</h1>
    <div class="image_check2">
        <img src="{{ asset('img/UPSC_banner.jpg') }}" style = "height: 450px; border: 1px solid rgba(0,0,0,.2); box-shadow: 5px 5px 5px rgba(0,0,0,.2); width: 100%; border-radius: 15px;" alt="UPSC banner pic">
    </div>
</section>

<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">Only "UPSC" Video Content !</h1>
</section>
...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 100px; margin-bottom: 30px;">Only "UPSC" PDF Content !</h1>
</section>
