...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From show_current_video_to_faculty_for_update_video_tutorial_page</div><br> -->
            <div class="center">
                <h2 id="main-heading">Current Video</h2>

                <div class="form_container">
                    <div id="form">
                        <video width="350" height="240" controls controlsList="nodownload">
                            <source src="{{ asset('storage/' . $current_video_to_show->video_tutorial_url) }}" type="video/mp4">
